<?php
/**
 * OnlineManager - ApkStore online counts management class
 * NOTE: 
 * Dependencies:
 *     'class.log.php' 
...
class OnlineManager{
	...
	private $table                  = DatabaseProxy::DB_TABLE_ONLINES;
	
	private $column_serial          = DatabaseProxy::DB_COLUMN_ONLINE_SERIAL;
	private $column_device	     	= DatabaseProxy::DB_COLUMN_ONLINE_DEV_SERIAL;
	private $column_date 			= DatabaseProxy::DB_COLUMN_ONLINE_DATE;
	private $column_counts       	= DatabaseProxy::DB_COLUMN_ONLINE_COUNTS;
	private $column_stamp         	= DatabaseProxy::DB_COLUMN_ONLINE_REPORT_STAMP;
	...
	public function fetchDeviceOnlineByPeriod($period_array,$cur_page, $limit)
	{
		$column_name = "name";
		$column_value = "value";
