<?php
/**
 *InstallManager - ApkStore install report management class
 * NOTE: 
 * Dependencies:
 *     'class.log.php' 
...
class InstallManager{
	...
	private $table                  = DatabaseProxy::DB_TABLE_INSTALLS;
	
	private $column_serial          = DatabaseProxy::DB_COLUMN_INSTALL_SERIAL;
	private $column_device	     	= DatabaseProxy::DB_COLUMN_INSTALL_DEV_SERIAL;
	private $column_package 		= DatabaseProxy::DB_COLUMN_INSTALL_PACKAGE;
	private $column_vercode       	= DatabaseProxy::DB_COLUMN_INSTALL_VERCODE;
	private $column_action         	= DatabaseProxy::DB_COLUMN_INSTALL_ACTION;
	private $column_action_stamp    = DatabaseProxy::DB_COLUMN_INSTALL_ACTION_STAMP;
	private $column_report_stamp    = DatabaseProxy::DB_COLUMN_INSTALL_REPORT_STAMP;
