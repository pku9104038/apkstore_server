<?php
/**
 * WidgetGroupManager - ApkStore widget_group counts management class
 * NOTE: 
 * Dependencies:
 *     'class.log.php' 
...
class WidgetGroupManager{
	...
	private $table                  = DatabaseProxy::DB_TABLE_WIDGET_GROUPS;
	
	private $column_serial          = DatabaseProxy::DB_COLUMN_WIDGET_GROUP_SERIAL;
	private $column_device	     	= DatabaseProxy::DB_COLUMN_WIDGET_GROUP_DEV_SERIAL;
	private $column_date 			= DatabaseProxy::DB_COLUMN_WIDGET_GROUP_DATE;
	private $column_counts       	= DatabaseProxy::DB_COLUMN_WIDGET_GROUP_COUNTS;
	private $column_stamp         	= DatabaseProxy::DB_COLUMN_WIDGET_GROUP_REPORT_STAMP;
	...
	public function fetchDeviceWidgetGroupByPeriod($period_array,$cur_page, $limit)
	{
		$column_name = "name";
		$column_value = "value";
