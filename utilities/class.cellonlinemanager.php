<?php
/**
 * CellOnlineManager - ApkStore cell_online counts management class
 * NOTE: 
 * Dependencies:
 *     'class.log.php' 
...
class CellOnlineManager{
	...
	private $table                  = DatabaseProxy::DB_TABLE_CELL_ONLINES;
	
	private $column_serial          = DatabaseProxy::DB_COLUMN_CELL_ONLINE_SERIAL;
	private $column_device	     	= DatabaseProxy::DB_COLUMN_CELL_ONLINE_DEV_SERIAL;
	private $column_date 			= DatabaseProxy::DB_COLUMN_CELL_ONLINE_DATE;
	private $column_counts       	= DatabaseProxy::DB_COLUMN_CELL_ONLINE_COUNTS;
	private $column_stamp         	= DatabaseProxy::DB_COLUMN_CELL_ONLINE_REPORT_STAMP;
