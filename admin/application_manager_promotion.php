					...
					<div align="center">
						<table width="100%" border="3">
							<tr>
								...
								<td>
									<div class="column_name"><a href="<?php echo $_SERVER['PHP_SELF']."?group_serial=$group_serial&sort=$column_producer&order=$reorder"; ?>">出品人</a></div>
								</td>
								<td>
...
$online = 1;
$array = $mgr->fetchApplicationsPromotion($sort, 1, 10000, $order,$online);
...
$array = $mgr->fetchApplicationsPromotion( $sort, $cur_page, $limit, $order,$online);
