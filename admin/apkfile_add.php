...
/*    
    ...
    $save = API_CONSTANTS::PATH_UPLOAD.$_FILES['apkfile']['name'];
    $err_msg = "upload:".$apkfile_upload." apkfile:".$apkfile_original." to:".$apkfile_path." type:".$apkfile_type." size:".$apkfile_size;
    if(copy($_FILES['apkfile']['tmp_name'],$save)){
        $err_msg .= ",save=$save";
    }
*/    
    $output_form = FALSE;
    ...
    $file_name = Utilities::convertFileName($_FILES['apkfile']['name']);
    $save = API_CONSTANTS::PATH_UPLOAD.$file_name;
