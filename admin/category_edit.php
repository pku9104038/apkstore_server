...
if (isset ( $_POST ['submit'] )) 
{
    ...
    if( $mgr->checkCategoryNew($serial,$category)){
        $err_category = "该应用类型已经存在！";
        $output_form = TRUE;
    }
    ...
    if (!$output_form){
        ...
        if($mgr->updateCategory($serial,$category, $group_serial, $notes)){
            $err_msg .= '"信息修改成功！';
        }
        else{
            $err_msg .= '"信息修改失败！';
				...
				<form method="post" action="<?php echo $_SERVER ['PHP_SELF']; ?>">
					<div align="center">
						...
						<table>
							<tr>
								<td>
									<div align="right"><label for="category_old">原类型名称：</label></div>
								</td>
								<td >
							...
							<tr>
								<td>
									<div align="right"><label for="category">新类型名称：</label></div>
								</td>
								<td >
