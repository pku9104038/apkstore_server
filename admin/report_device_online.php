...
require '../res/selector_period_date.php';
...
<?php
require_once '../utilities/class.onlinemanager.php';
$mgr = new OnlineManager();
...
$array = $mgr->fetchDeviceOnlineByPeriod($period_array, $cur_page, $limit);
$count_total = 0;
$count_min = 0;
$count_max = 0;
$area_min = "";
