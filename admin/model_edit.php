...
if (isset ( $_POST ['submit'] )) 
{
    ...
    $customer_serial = $_POST['customer_serial'] + 0;
    $brand_serial = $_POST ['brand_serial'] + 0;
    $notes = $_POST ['notes'];
    ...
    if (!$output_form){
        if($mgr->updateModel($model_serial, $brand_serial,$customer_serial, $notes)){
            $err_msg = '新型号"'.$model.'"信息修改成功！';
        }
        else{
            $err_msg = '新型号"'.$model.'"信息修改失败！';
            $output_form = TRUE;
        }
    }
    ...
    $customer_serial = $_GET['customer_serial'] + 0;
    $brand_serial = $_GET ['brand_serial'] + 0;
    $notes = $_GET ['notes'];
						...
						<table>
							<tr>
								...
								<td >
									...
									<input id="model_serial" name="model_serial" type="text" value="<?php echo $model_serial; ?>" />
