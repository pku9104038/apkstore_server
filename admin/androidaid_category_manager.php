...
$column_group_serial = DatabaseProxy::DB_COLUMN_CATEGORY_ANDROIDAID_GROUP_SERIAL;
...
$array = $mgr->fetchAndroidAidCategories($sort, $cur_page, $limit, $order);
...
<?php 
    echo  '<div class="column_value_center"><a href="androidaid_category_mapping.php'
