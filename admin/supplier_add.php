...
if (isset ( $_POST ['submit'] )) 
{
    ...
    if (!$output_form){
        if($mgr->addSupplier($supplier, $type_id,$contact, $email, $phone, $notes,$audit_url, $audit_account, $audit_pwd)){
            $err_msg = '新供应商"'.$supplier.'"添加成功！';
        }
        else{
            $err_msg = '新供应商"'.$supplier.'"添加失败！';
            $output_form = TRUE;
        }
    }
					...
					<div align="center">
						...
						<table>
							<tr>
								...
								<td >
									<input id="supplier" name="supplier" type="text" value="<?php echo $supplier; ?>" />
