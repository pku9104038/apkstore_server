...
$array_groups = $mgr->fetchGroups($sort, $cur_page, $limit, $order,$customer_serial);
if (count($array_groups)<1) {
	$link = "../customer/customer_group_add.php";
	$link_name = "添加新分组";
}
